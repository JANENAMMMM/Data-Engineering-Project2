...
sys.path.insert(0, str(Path(__file__).parent.parent.parent / "pipeline".parent / 'pipeline'))
...
LABELS_DIR = Path(__file__).parent.parent.parent / "pipeline".parent / "pipeline" / "data" / "labels"
OUT_PATH   = Path(__file__).parent.parent.parent / "pipeline".parent / "pipeline" / "output" / "tasks.json"
